...
use storage::*;
use event::*;
use protocol_interface::SoroswapRouterClient;
...
impl AdapterTrait for SoroswapAdapter {
    ...
    fn swap_exact_in(
        ...
        let _router = SoroswapRouterClient::new(&e, &get_amm(&e)?);
