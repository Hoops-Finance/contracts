...
use storage::*;
use event::*;
use protocol_interface::CometRouterClient;
...
impl AdapterTrait for CometAdapter {
    ...
    fn swap_exact_in(
        ...
        let _router = CometRouterClient::new(&e, &get_amm(&e)?);
