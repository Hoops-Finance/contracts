...
use storage::*;
use event::*;
use protocol_interface::PhoenixRouterClient;
...
impl AdapterTrait for PhoenixAdapter {
    ...
    fn swap_exact_in(
        ...
        let _router = PhoenixRouterClient::new(&e, &get_amm(&e)?);
