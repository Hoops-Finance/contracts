...
mod pair {
    soroban_sdk::contractimport!(file = "../pair/bytecodes/soroswap_pair.wasm");
    pub type SoroswapPairClient<'a> = Client<'a>;
}
mod token {
    soroban_sdk::contractimport!(file = "../token/bytecodes/soroban_token_contract.wasm");
    pub type TokenClient<'a> = Client<'a>;
}
mod factory {
    soroban_sdk::contractimport!(file = "../factory/bytecodes/soroswap_factory.wasm");
...
impl<'a> SoroswapRouterTest<'a> {
    fn new() -> Self {
        ...
        // pair::soroswap_router_tests::operations has other related tests with Pair and Token initialization.
        // env.mock_all_auths();
...
pub fn swap_exact_tokens_for_tokens() {
    ...
    router_test.env.cost_estimate().budget().reset_unlimited();
