use crate::soroswap_router_tests::{SoroswapRouterTest, SoroswapPairClient};
extern crate std;
...
pub fn add_liquidity(
    ...
    std::println!("[add_liquidity] Adding liquidity with amount_0: {}, amount_1: {}", amount_0, amount_1);

        test.env.cost_estimate().budget().reset_unlimited();
       let liquidity = test.contract.add_liquidity(
    ...
    std::println!("[add_liquidity] Liquidity added: {:?}", liquidity);
    liquidity
