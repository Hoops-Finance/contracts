#![cfg(test)]
extern crate std;
use crate::soroswap_pair_tests::{SoroswapPairTest, deposit::add_liquidity  };
...
fn test_zero_allowance() {
    ...
    let token_client = SoroswapPairTokenClient::new(&test.env, &test.env.register(SoroswapPairToken {}, ()));
