...
#[test]
fn test_aqua_router_constant_product_pool() {
    let setup = Setup::default();
    let e = setup.env;
...
#[test]
fn test_aqua_router_add_pool_after_removal() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, token2, _, _] = setup.tokens;
...
fn test_aqua_router_stableswap_pools_amount_over_max() {
    let setup = Setup::default();
    let e = setup.env;
...
#[test]
fn test_aqua_router_stableswap_pools_amount_ok() {
    let setup = Setup::default();
    let e = setup.env;
    let admin = setup.admin;
    let router = setup.router;
...
fn test_aqua_router_stableswap_pool_no_balance() {
    let setup = Setup::default();
    let e = setup.env;
    let admin = setup.admin;
    let router = setup.router;
...
#[test]
fn test_aqua_router_stableswap_pool() {
    let setup = Setup::default();
    let e = setup.env;
    let admin = setup.admin;
    let router = setup.router;
...
#[test]
fn test_aqua_router_stableswap_3_pool() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
...
#[test]
fn test_aqua_router_init_pool_twice() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, token2, _, _] = setup.tokens;
...
#[test]
fn test_aqua_router_init_pool_bad_tokens() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
...
#[should_panic(expected = "Error(WasmVm, MissingValue)")]
#[test]
fn test_aqua_router_init_standard_pool_bad_tokens() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, _, _, _] = setup.tokens;
...
#[should_panic(expected = "Error(WasmVm, MissingValue)")]
#[test]
fn test_aqua_router_init_stable_pool_bad_tokens() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, _, _, _] = setup.tokens;
...
#[test]
fn test_aqua_router_simple_ongoing_reward() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_rewards_distribution() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_rewards_distribution_as_operator() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_rewards_distribution_override() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_liqidity_not_filled() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_fill_liqidity_reentrancy() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_config_pool_rewards_reentrancy() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_config_pool_rewards_after_new_global_config() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_config_pool_after_liquidity_fill() {
...
fn test_aqua_router_fill_liquidity_no_config() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_config_rewards_not_admin() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_config_rewards_duplicated_tokens() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_config_rewards_tokens_not_sorted() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_config_rewards_no_pools_for_tokens() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_unexpected_fee() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, token2, _, _] = setup.tokens;
...
#[test]
fn test_aqua_router_event_correct() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
#[should_panic(expected = "Error(Contract, #302)")]
fn test_aqua_router_stableswap_validation_fee_out_of_bounds() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let [token1, token2, _, _] = setup.tokens;
...
#[test]
fn test_aqua_router_chained_swap() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_chained_swap_strict_receive() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
fn test_aqua_router_chained_swap_min_not_met() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_create_pool_payment() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_rewards_distribution_without_outstanding_rewards() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
    let admin = setup.admin;
...
#[test]
fn test_aqua_router_privileged_users() {
    let setup = Setup::default();
    let e = setup.env;
    let router = setup.router;
...
#[test]
fn test_aqua_router_set_privileged_addresses_event() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
fn test_aqua_router_transfer_ownership_events() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
fn test_aqua_router_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_router_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.router;
...
#[test]
fn test_aqua_router_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.router;
...
#[test]
fn test_aqua_router_regular_upgrade() {
    let setup = Setup::default();
    let contract = setup.router;
    let new_wasm = install_dummy_wasm(&setup.env);
