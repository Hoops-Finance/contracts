...
fn test_aqua_router_permissions_admin_transfer_ownership_too_early() {
...
fn test_aqua_router_permissions_admin_transfer_ownership_twice() {
    let setup = Setup::default();
    let router = setup.router;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
fn test_aqua_router_permissions_admin_transfer_ownership_not_committed() {
    let setup = Setup::default();
    let router = setup.router;
    let admin_original = setup.admin;
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_router_permissions_admin_transfer_ownership_reverted() {
    let setup = Setup::default();
    let router = setup.router;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_admin_transfer_ownership() {
    let setup = Setup::default();
    let router = setup.router;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
#[test]
#[should_panic(expected = "Error(Contract, #2908)")]
fn test_aqua_router_permissions_emergency_admin_transfer_ownership_too_early() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
#[should_panic(expected = "Error(Contract, #2906)")]
fn test_aqua_router_permissions_emergency_admin_transfer_ownership_twice() {
    let setup = Setup::default();
    let router = setup.router;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_router_permissions_emergency_admin_transfer_ownership_not_committed() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_router_permissions_emergency_admin_transfer_ownership_reverted() {
    let setup = Setup::default();
    let router = setup.router;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_emergency_admin_transfer_ownership() {
    let setup = Setup::default();
    let router = setup.router;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_transfer_ownership_separate_deadlines() {
    let setup = Setup::default();
    let router = setup.router;
    let admin_new = Address::generate(&setup.env);
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_set_pools_router() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
fn test_aqua_router_permissions_set_liquidity_calculator() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
fn test_aqua_router_permissions_set_privileged_addresses() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_set_hashes() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_set_reward_token() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_commit_upgrade() {
    let setup = Setup::default();
    let router = setup.router;
...
// apply upgrade
#[test]
fn test_aqua_router_permissions_apply_upgrade_third_party_user() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_emergency_admin() {
    let setup = Setup::default();
    let router = setup.router;
    // Upgrade router code with token wasm as it has no dependencies
    // after upgrade router cannot be reused
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_admin() {
    let setup = Setup::default();
    let router = setup.router;
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_rewards_admin() {
    let setup = Setup::default();
    let router = setup.router;
    // Upgrade router code with token wasm as it has no dependencies
    // after upgrade router cannot be reused
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_operations_admin() {
    let setup = Setup::default();
    let router = setup.router;
    // Upgrade router code with token wasm as it has no dependencies
    // after upgrade router cannot be reused
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_pause_admin() {
    let setup = Setup::default();
    let router = setup.router;
    // Upgrade router code with token wasm as it has no dependencies
    // after upgrade router cannot be reused
...
#[test]
fn test_aqua_router_permissions_apply_upgrade_emergency_pause_admin() {
    let setup = Setup::default();
    let router = setup.router;
    // Upgrade router code with token wasm as it has no dependencies
    // after upgrade router cannot be reused
...
#[test]
fn test_aqua_router_permissions_set_emergency_mode() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
// reward admin
#[test]
fn test_aqua_router_permissions_config_rewards() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_distribute_rewards() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
    let [token1, token2, _, _] = setup.tokens;
...
#[test]
fn test_aqua_router_permissions_configure_init_pool_payment() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_router_permissions_remove_pool() {
    let setup = Setup::default();
    let router = setup.router;
    let user = Address::generate(&setup.env);
    let [token1, token2, _, _] = setup.tokens;
