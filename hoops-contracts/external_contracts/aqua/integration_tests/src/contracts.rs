pub(crate) mod pool_create_fees_collector {
    soroban_sdk::contractimport!(file = "../../../bytecodes/aqua_fees_collector_contract.wasm");
}
...
pub(crate) mod liquidity_calculator {
    soroban_sdk::contractimport!(
        file = "../../../bytecodes/aqua_liquidity_pool_liquidity_calculator_contract.wasm"
    );
}
...
pub(crate) mod swap_fee_factory {
    soroban_sdk::contractimport!(
        file = "../../../bytecodes/aqua_liquidity_pool_provider_swap_fee_factory_contract.wasm"
    );
}
...
pub(crate) mod boost_feed {
    soroban_sdk::contractimport!(file = "../../../bytecodes/aqua_locker_feed_contract.wasm");
}
pub(crate) mod lp_token {
    //soroban_sdk::contractimport!(file = "../../../bytecodes/token_share.wasm");
    soroban_sdk::contractimport!(file = "../../../bytecodes/soroban_token_contract_aqua.wasm");
}
