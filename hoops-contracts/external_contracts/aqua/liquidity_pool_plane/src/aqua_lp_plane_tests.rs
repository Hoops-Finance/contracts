...
#[test]
fn test_aqua_plane_init_admin_twice() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_plane_transfer_ownership_events() {
...
#[test]
fn test_aqua_plane_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_plane_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.plane;
...
#[test]
fn test_aqua_plane_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.plane;
...
#[test]
fn test_aqua_plane_regular_upgrade() {
    let setup = Setup::default();
    let contract = setup.plane;
    let new_wasm = install_dummy_wasm(&setup.env);
