...
fn test_aqua_swap_fee_factory_admin_transfer_ownership_too_early() {
...
fn test_aqua_swap_fee_factory_admin_transfer_ownership_twice() {
    let setup = Setup::default();
    let contract = setup.contract;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
fn test_aqua_swap_fee_factory_admin_transfer_ownership_not_committed() {
    let setup = Setup::default();
    let contract = setup.contract;
    let admin_original = setup.admin;
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_swap_fee_factory_admin_transfer_ownership_reverted() {
    let setup = Setup::default();
    let contract = setup.contract;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_swap_fee_factory_admin_transfer_ownership() {
    let setup = Setup::default();
    let contract = setup.contract;
    let admin_original = setup.admin;
    let admin_new = Address::generate(&setup.env);
...
#[test]
#[should_panic(expected = "Error(Contract, #2908)")]
fn test_aqua_swap_fee_factory_emergency_admin_transfer_ownership_too_early() {
    let setup = Setup::default();
    let contract = setup.contract;
...
#[test]
#[should_panic(expected = "Error(Contract, #2906)")]
fn test_aqua_swap_fee_factory_emergency_admin_transfer_ownership_twice() {
    let setup = Setup::default();
    let contract = setup.contract;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_swap_fee_factory_emergency_admin_transfer_ownership_not_committed() {
    let setup = Setup::default();
    let contract = setup.contract;
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_swap_fee_factory_emergency_admin_transfer_ownership_reverted() {
    let setup = Setup::default();
    let contract = setup.contract;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_swap_fee_factory_emergency_admin_transfer_ownership() {
    let setup = Setup::default();
    let contract = setup.contract;
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
fn test_aqua_swap_fee_factory_transfer_ownership_separate_deadlines() {
    let setup = Setup::default();
    let contract = setup.contract;
    let admin_new = Address::generate(&setup.env);
    let emergency_admin_new = Address::generate(&setup.env);
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_swap_fee_factory_get_future_address_empty() {
    let env = Env::default();
    env.mock_all_auths();
...
// upgrade
#[test]
fn test_aqua_swap_fee_factory_commit_upgrade_third_party_user() {
    let setup = Setup::default();
    let contract = setup.contract;
...
#[test]
fn test_aqua_swap_fee_factory_commit_upgrade_emergency_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    assert!(contract
...
#[test]
fn test_aqua_swap_fee_factory_commit_upgrade_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    assert!(contract
...
#[test]
fn test_aqua_swap_fee_factory_apply_upgrade_third_party_user() {
    let setup = Setup::default();
    let contract = setup.contract;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_swap_fee_factory_apply_upgrade_emergency_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    contract.commit_upgrade(&setup.admin, &install_dummy_wasm(&setup.env));
    jump(&setup.env, ADMIN_ACTIONS_DELAY + 1);
...
#[test]
fn test_aqua_swap_fee_factory_apply_upgrade_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    contract.commit_upgrade(&setup.admin, &install_dummy_wasm(&setup.env));
    jump(&setup.env, ADMIN_ACTIONS_DELAY + 1);
...
// emergency mode
#[test]
fn test_aqua_swap_fee_factory_set_emergency_mode_third_party_user() {
    let setup = Setup::default();
    let contract = setup.contract;
    let user = Address::generate(&setup.env);
...
#[test]
fn test_aqua_swap_fee_factory_set_emergency_mode_emergency_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    assert!(contract
...
#[test]
fn test_aqua_swap_fee_factory_set_emergency_mode_admin() {
    let setup = Setup::default();
    let contract = setup.contract;
    assert!(contract
        .try_set_emergency_mode(&setup.emergency_admin, &false)
