...
use core::cmp::min;
use aqua_rewards::aqua_utils::test_utils::assert_approx_eq_abs;
use soroban_sdk::testutils::{Address as _, Events};
use soroban_sdk::{symbol_short, vec, Address, Env, Error, IntoVal, Symbol, Val, Vec};
use aqua_token_share::Client as ShareTokenClient;
...
use aqua_utils::test_utils::{install_dummy_wasm, jump};

#[test]
#[should_panic(expected = "Error(Contract, #2010)")]
fn test_aqua_stableswap_swap_empty_pool() {
    let e = Env::default();
    e.mock_all_auths();
...
#[test]
fn test_aqua_stableswap_happy_flow() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_strict_receive() {
    // mirror calculations from test_aqua_stableswap_happy_flow to ensure that swap_strict_receive works as expected
    ...
    // that's what we expect from test_aqua_stableswap_happy_flow
...
#[test]
fn test_aqua_stableswap_strict_receive_over_max() {
    let setup = Setup::new_with_config(&TestConfig {
        a: 10,
        liq_pool_fee: 30,
        ..TestConfig::default()
...
#[test]
fn test_aqua_stableswap_happy_flow_different_decimals() {
    // values should not differ from test_aqua_stableswap_happy_flow, only the decimals of the tokens
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_strict_receive_different_decimals() {
    // mirror calculations from test_aqua_stableswap_happy_flow_different_decimals to ensure that swap_strict_receive works as expected
    let setup = Setup::new_with_config(&TestConfig {
        a: 10,
        liq_pool_fee: 2000,
        token_2_decimals: 18,
    ...
    // that's what we expect from test_aqua_stableswap_happy_flow_different_decimals
    assert_eq!(
        liqpool.estimate_swap(&0, &1, &10_0000000),
...
#[test]
fn test_aqua_stableswap_events_2_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_events_3_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_events_4_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_pool_imbalance_draw_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_pool_imbalance_draw_tokens_different_decimals() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_pool_zero_swap() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_bad_fee() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_zero_initial_deposit() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_zero_deposit_ok() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_happy_flow_3_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_happy_flow_4_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_withdraw_partial() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_withdraw_one_token() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_withdraw_one_token_different_decimals() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_custom_fee() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_deposit_inequal() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_deposit_inequal_different_decimals() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_remove_liquidity_imbalance() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_remove_liquidity_imbalance_different_decimals() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_simple_ongoing_reward() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_simple_ongoing_reward_different_decimals() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_simple_reward() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_two_users_rewards() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_boosted_rewards() {
...
#[test]
fn test_aqua_stableswap_lazy_user_rewards() {
...
fn test_aqua_stableswap_config_rewards_not_admin() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_config_rewards_router() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_update_fee_too_early() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_update_fee() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
#[should_panic(expected = "Error(Contract, #2908)")]
fn test_aqua_stableswap_transfer_ownership_too_early() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_transfer_ownership_twice() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_transfer_ownership_not_committed() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
#[should_panic(expected = "Error(Contract, #2907)")]
fn test_aqua_stableswap_transfer_ownership_reverted() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_transfer_ownership() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_ramp_a_too_early() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_ramp_a_too_short() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_ramp_a_too_fast() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_ramp_a() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
fn test_aqua_stableswap_deposit_min_mint() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_deposit_inequal_ok() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_large_numbers() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_kill_deposit() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_kill_swap() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_kill_claim() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_withdraw_rewards() {
    let e = Env::default();
    e.mock_all_auths();
...
#[test]
fn test_aqua_stableswap_deposit_rewards() {
...
#[test]
fn test_aqua_stableswap_swap_rewards() {
...
#[test]
fn test_aqua_stableswap_decimals_in_swap_pool() {
    let e = Env::default();
    e.mock_all_auths();
...
#[test]
fn test_aqua_stableswap_claim_rewards() {
...
#[test]
fn test_aqua_stableswap_drain_reward() {
    // test pool reserves are not affected by rewards if reward token is one of pool tokens and presented in pool balance
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_drain_reserves() {
    // test pool reserves are not affected by rewards if reward token is one of pool tokens and presented in pool balance
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_stableswap_return_unused_reward() {
    let setup = Setup::new_with_config(&TestConfig {
...
#[test]
fn test_aqua_stableswap_return_unused_reward_reward_token_in_pool() {
    let setup = Setup::new_with_config(&TestConfig {
...
#[test]
fn test_aqua_stableswap_kill_deposit_event() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_stableswap_kill_swap_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_kill_claim_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_unkill_deposit_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_unkill_swap_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_unkill_claim_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_set_privileged_addresses_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_set_rewards_config() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_transfer_ownership_events() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_ramp_a_events() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_set_fee_events() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_stableswap_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
...
#[test]
fn test_aqua_stableswap_regular_upgrade_token() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
    let token = ShareTokenClient::new(&setup.env, &contract.share_id());
    ...
    let token_wasm = setup
        .env
        .deployer()
        .upload_contract_wasm(aqua_token_share::token::WASM);
    let new_wasm = install_dummy_wasm(&setup.env);
...
#[test]
fn test_aqua_stableswap_regular_upgrade_pool() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
    let token = ShareTokenClient::new(&setup.env, &contract.share_id());
...
#[test]
fn test_aqua_stableswap_claim_event() {
    let setup = Setup::default();
    let liq_pool = setup.liq_pool;
