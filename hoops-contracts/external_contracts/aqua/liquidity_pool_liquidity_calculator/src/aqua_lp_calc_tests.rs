...
#[test]
fn test_aqua_calc_bad_math_big_tokens_value_difference() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_calc_liquidity_overflow() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_calc_multiple_tokens() {
    let e = Env::default();
    e.mock_all_auths();
    e.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_aqua_calc_transfer_ownership_events() {
...
#[test]
fn test_aqua_calc_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_calc_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.calculator;
...
#[test]
fn test_aqua_calc_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.calculator;
...
#[test]
fn test_aqua_calc_regular_upgrade() {
    let setup = Setup::default();
    let contract = setup.calculator;
    let new_wasm = install_dummy_wasm(&setup.env);
