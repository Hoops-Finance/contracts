...
use aqua_utils::test_utils::{assert_approx_eq_abs, install_dummy_wasm, jump};
...
#[test]
fn test_aqua_pool_strict_receive() {
    let setup = Setup::new_with_config(&TestConfig {
        mint_to_user: i128::MAX,
        ..TestConfig::default()
    });
...
#[test]
fn test_aqua_pool_strict_receive_over_max() {
    let setup = Setup::new_with_config(&TestConfig {
        mint_to_user: i128::MAX,
        ..TestConfig::default()
    });
...
fn test_aqua_pool_deposit_min_mint() {
    let setup = Setup::new_with_config(&TestConfig {
        mint_to_user: i128::MAX,
        ..TestConfig::default()
    });
...
fn test_aqua_pool_zero_initial_deposit() {
...
#[test]
fn test_aqua_pool_zero_deposit_ok() {
    let setup = Setup::default();
    let liq_pool = setup.liq_pool;
    let user1 = setup.users[0].clone();
...
#[test]
fn test_aqua_pool_simple_ongoing_reward() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let token_reward = setup.token_reward;
...
#[test]
fn test_aqua_pool_estimate_ongoing_reward() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let token_reward = setup.token_reward;
...
#[test]
fn test_aqua_pool_simple_reward() {
...
#[test]
fn test_aqua_pool_two_users_rewards() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let token_reward = setup.token_reward;
...
#[test]
fn test_aqua_pool_boosted_rewards() {
    let setup = Setup::new_with_config(&TestConfig {
        users_count: 3,
        ..TestConfig::default()
    });
...
#[test]
fn test_aqua_pool_lazy_user_rewards() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let token_reward = setup.token_reward;
...
#[test]
fn test_aqua_pool_rewards_disable_before_expiration() {
    let setup = Setup::new_with_config(&TestConfig {
        users_count: 3,
        reward_tps: 0,
        ..TestConfig::default()
...
#[test]
fn test_aqua_pool_rewards_disable_after_expiration() {
    let setup = Setup::new_with_config(&TestConfig {
        reward_tps: 0,
        ..TestConfig::default()
    });
...
#[test]
fn test_aqua_pool_rewards_set_new_after_expiration() {
    let setup = Setup::new_with_config(&TestConfig {
        reward_tps: 0,
        ..TestConfig::default()
    });
...
fn test_aqua_pool_rewards_same_expiration_time() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let users = setup.users;
...
fn test_aqua_pool_rewards_past() {
    let setup = Setup::default();
    let env = setup.env;
    let liq_pool = setup.liq_pool;
    let users = setup.users;
...
fn test_aqua_pool_rewards_many_users(iterations_to_simulate: u32) {
...
#[test]
fn test_aqua_pool_deposit_inequal_return_change() {
    let setup = Setup::default();
    let e = setup.env;
    let liq_pool = setup.liq_pool;
    let token1 = setup.token1;
...
#[test]
fn test_aqua_pool_rewards_1k() {
    test_aqua_pool_rewards_many_users(1_000);
}

#[cfg(feature = "slow_tests")]
#[test]
fn test_aqua_pool_rewards_50k() {
    test_aqua_pool_rewards_many_users(50_000);
}

#[test]
#[should_panic(expected = "Error(Contract, #102)")]
fn test_aqua_pool_config_rewards_not_admin() {
    let setup = Setup::setup(&TestConfig::default());
    setup.mint_tokens_for_users(TestConfig::default().mint_to_user);
    let env = setup.env;
    let liq_pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_config_rewards_router() {
    let setup = Setup::setup(&TestConfig::default());
    setup.mint_tokens_for_users(TestConfig::default().mint_to_user);
    let env = setup.env;
    let liq_pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_config_rewards_override() {
    let setup = Setup::setup(&TestConfig::default());
    setup.mint_tokens_for_users(TestConfig::default().mint_to_user);
    let env = setup.env;
    let liq_pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_large_numbers() {
    let setup = Setup::new_with_config(&TestConfig {
        mint_to_user: i128::MAX,
        ..TestConfig::default()
    });
...
#[test]
fn test_aqua_pool_deposit_killed() {
    let setup = Setup::new_with_config(&TestConfig {
        mint_to_user: i128::MAX,
        ..TestConfig::default()
    });
...
#[test]
fn test_aqua_pool_claim_killed() {
    let setup = Setup::setup(&TestConfig::default());
    setup.mint_tokens_for_users(TestConfig::default().mint_to_user);
    let env = setup.env;
    let liq_pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_withdraw_rewards() {
...
#[test]
fn test_aqua_pool_deposit_rewards() {
...
#[test]
fn test_aqua_pool_swap_rewards() {
...
#[test]
fn test_aqua_pool_claim_rewards() {
...
#[test]
fn test_aqua_pool_drain_reward() {
    let setup = Setup::new_with_config(&TestConfig {
        users_count: 5,
...
#[test]
fn test_aqua_pool_drain_reserves() {
    // test pool reserves are not affected by rewards if reward token is one of pool tokens and presented in pool balance
    let e = Env::default();
    e.mock_all_auths();
...
#[test]
fn test_aqua_pool_return_unused_reward() {
    let setup = Setup::new_with_config(&TestConfig {
        reward_tps: 0,
...
#[test]
fn test_aqua_pool_return_unused_reward_reward_token_in_pool() {
    let setup = Setup::new_with_config(&TestConfig {
        reward_tps: 0,
...
#[test]
fn test_aqua_pool_kill_deposit_event() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_pool_kill_swap_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_kill_claim_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_unkill_deposit_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_unkill_swap_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_unkill_claim_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_set_privileged_addresses_event() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_set_rewards_config() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_transfer_ownership_events() {
    let setup = Setup::default();
    let pool = setup.liq_pool;
...
#[test]
fn test_aqua_pool_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_pool_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
...
#[test]
fn test_aqua_pool_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
...
#[test]
fn test_aqua_pool_regular_upgrade_token() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
    let token = ShareTokenClient::new(&setup.env, &contract.share_id());
...
#[test]
fn test_aqua_pool_regular_upgrade_pool() {
    let setup = Setup::default();
    let contract = setup.liq_pool;
    let token = ShareTokenClient::new(&setup.env, &contract.share_id());
