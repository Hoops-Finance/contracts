...
#[test]
fn test_aqua_fee_init_admin_twice() {
    let setup = Setup::default();
    setup.collector.init_admin(&setup.admin);
}

#[test]
fn test_aqua_fee_transfer_ownership_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_fee_upgrade_events() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_fee_emergency_mode_events() {
    let setup = Setup::default();
    let contract = setup.collector;
...
#[test]
fn test_aqua_fee_emergency_upgrade() {
    let setup = Setup::default();
    let contract = setup.collector;
...
#[test]
fn test_aqua_fee_regular_upgrade() {
    let setup = Setup::default();
    let contract = setup.collector;
    let new_wasm = install_dummy_wasm(&setup.env);
