...
#[test]
fn test_aqua_provider_swap_fee_strict_send() {
...
#[test]
fn test_aqua_provider_swap_fee_strict_receive() {
    let setup = Setup::default();
...
fn test_aqua_provider_swap_fee_strict_send_fee_over_max() {
    let setup = Setup::default();
...
#[test]
#[should_panic(expected = "Error(Contract, #2904)")]
fn test_aqua_provider_swap_fee_strict_receive_fee_over_max() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_strict_send_bad_slippage() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_strict_receive_bad_slippage() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_strict_send_no_fee() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_strict_receive_no_fee() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_claim_fee() {
    let setup = Setup::default();
...
#[test]
fn test_aqua_provider_swap_fee_claim_fee_and_swap() {
    let setup = Setup::default();
