...
pub mod phoenix_stake_tests {
    ...
    pub mod old_stake {
        soroban_sdk::contractimport!(
    file = "../../../bytecodes/old_phoenix_stake.wasm"
        );
    }
    ...
    use crate::phoenix_stake_tests::setup::{install_stake_wasm, latest_stake};
    ...
    fn upgrade_stake_contract() {
        ...
        use crate::phoenix_stake_tests::setup::{deploy_token_contract, install_stake_latest_wasm};
