...
pub fn install_stake_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(
        file = "/home/silence/hoops-target/wasm32v1-none/release/phoenix_stake.wasm"
    );
...
pub mod tests {
    ...
    pub mod token {
        ...
        soroban_sdk::contractimport!(
            file = "/home/silence/hoops-target/wasm32v1-none/release/soroban_token_contract.wasm"
        );
    }
    ...
    pub mod old_stake {
        soroban_sdk::contractimport!(
    file = "/mnt/c/soroban-workspace/external-repositories/phoenix-amm/.artifacts_stake_migration_test/old_phoenix_stake.wasm"
        );
    }
