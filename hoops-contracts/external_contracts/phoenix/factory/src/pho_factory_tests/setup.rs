...
#[cfg(feature = "upgrade")]
pub mod old_factory {
    soroban_sdk::contractimport!(file = "../../../../../bytecodes/old_phoenix_factory.wasm");
}
...
pub fn old_lp_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(file = "../../../../../bytecodes/old_phoenix_pool.wasm");
    env.deployer().upload_contract_wasm(WASM)
}
...
pub fn old_stake_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(file = "../../../../../bytecodes/old_phoenix_stake.wasm");
    env.deployer().upload_contract_wasm(WASM)
}
