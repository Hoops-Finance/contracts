...
use crate::{error::ContractError, storage::PENDING_ADMIN, pho_factory_tests::setup::deploy_factory_contract};
use phoenix::utils::AdminChange;

#[test]
fn test_pho_factory_propose_admin() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_replace_admin_fails_when_new_admin_is_same_as_current() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_accept_admin_successfully() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_accept_admin_fails_when_no_pending_admin() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_accept_admin_fails_when_time_limit_expired() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_accept_admin_successfully_with_time_limit() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_accept_admin_successfully_on_time_limit() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_propose_admin_then_revoke() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_factory_revoke_admin_should_fail_when_no_admin_change_in_place() {
    let env = Env::default();
    env.mock_all_auths();
    ...
    assert_eq!(
        factory.try_revoke_admin_change(),
        Err(Ok(ContractError::NoAdminChangeInPlace))
    );
}
