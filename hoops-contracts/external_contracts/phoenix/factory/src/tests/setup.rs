...
const TOKEN_WASM: &[u8] =
    include_bytes!("../../../../../target/wasm32v1-none/release/soroban_token_contract.wasm");

#[allow(clippy::too_many_arguments)]
#[cfg(feature = "upgrade")]
pub mod old_factory {
    soroban_sdk::contractimport!(file = "../../../../../target/wasm32v1-none/release/phoenix/sdk-update-artifactsold_phoenix_factory.wasm");
}

#[allow(clippy::too_many_arguments)]
#[cfg(feature = "upgrade")]
pub fn install_old_multihop_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(file = "../../../../../target/wasm32v1-none/release/phoenix/sdk-update-artifactsold_phoenix_multihop.wasm");
...
pub fn old_lp_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(file = "../../../../../target/wasm32v1-none/release/phoenix/sdk-update-artifactsold_phoenix_pool.wasm");
    env.deployer().upload_contract_wasm(WASM)
}
...
pub fn old_stake_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(file = "../../../../../target/wasm32v1-none/release/phoenix/sdk-update-artifactsold_phoenix_stake.wasm");
    env.deployer().upload_contract_wasm(WASM)
}
...
pub fn install_multihop_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(
        file = "../../../target/wasm32v1-none/release/phoenix/phoenix_multihop.wasm"
    );
    env.deployer().upload_contract_wasm(WASM)
}
