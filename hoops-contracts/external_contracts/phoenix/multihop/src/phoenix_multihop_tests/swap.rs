...
use crate::phoenix_multihop_tests::setup::{
...
#[test]
fn test_pho_multihop_swap_three_equal_pools_no_fees() {
    let env = Env::default();
...
#[ignore]
#[test]
fn test_pho_multihop_swap_three_equal_pools_no_fees_referral_fee() {
    let env = Env::default();
...
#[test]
fn test_pho_multihop_swap_single_pool_no_fees() {
    let env = Env::default();
    let admin = Address::generate(&env);
...
fn test_pho_multihop_swap_should_fail_when_spread_exceeds_the_limit() {
    let env = Env::default();
    let admin = Address::generate(&env);
...
#[test]
fn test_pho_multihop_swap_single_pool_with_fees() {
    let env = Env::default();
    let admin = Address::generate(&env);
...
#[test]
fn test_pho_multihop_swap_three_different_pools_no_fees() {
    let env = Env::default();
...
#[test]
fn test_pho_multihop_swap_three_different_pools_with_fees() {
    let env = Env::default();
...
fn test_pho_multihop_swap_panics_with_no_operations() {
    let env = Env::default();
    env.mock_all_auths();
    let admin = Address::generate(&env);
...
#[test]
fn test_pho_multihop_v_phx_vul_013_add_belief_price_for_every_swap() {
    let env = Env::default();
...
fn test_pho_multihop_test_swap_with_ask_asset_min_amount() {
    let env = Env::default();
    let admin = Address::generate(&env);
...
#[test]
fn test_pho_multihop_swap_three_equal_stable_pool() {
    let env = Env::default();
