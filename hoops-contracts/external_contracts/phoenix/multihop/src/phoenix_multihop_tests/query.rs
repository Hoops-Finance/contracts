...
#[test]
fn test_pho_multihop_simulate_swap_single_pool_no_fees() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_multihop_simulate_swap_three_equal_pools_no_fees() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_pho_multihop_simulate_swap_single_pool_with_fees() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_pho_multihop_simulate_swap_three_different_pools_no_fees() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_pho_multihop_simulate_swap_three_different_pools_with_fees() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_multihop_query_simulate_swap_panics_with_no_operations() {
    let env = Env::default();
    env.mock_all_auths();
    let admin = Address::generate(&env);
...
fn test_pho_multihop_query_simulate_reverse_swap_panics_with_no_operations() {
    let env = Env::default();
    env.mock_all_auths();
    let admin = Address::generate(&env);
    let factory = Address::generate(&env);
...
#[test]
fn test_pho_multihop_simulate_swap_stable_pool() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
