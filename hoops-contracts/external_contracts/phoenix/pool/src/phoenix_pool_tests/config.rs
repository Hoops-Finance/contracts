...
#[test]
fn test_pho_pool_initialize_with_bigger_first_token_should_fail() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_pool_update_config() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_update_config_unauthorized() {
    let env = Env::default();
...
#[test]
fn test_pho_pool_update_config_update_admin() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_update_config_too_high_fees() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_pool_update_configs_all_bps_values_should_work() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_pho_pool_initialize_with_maximum_allowed_swap_fee_bps_over_the_cap_should_fail() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
