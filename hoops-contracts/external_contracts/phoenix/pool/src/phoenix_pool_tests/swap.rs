...
#[test]
fn test_pho_pool_pho_pool_simple_swap() {
    let env = Env::default();
    env.mock_all_auths();
...
#[test]
fn test_pho_pool_pho_pool_simple_swap_with_preferred_pool_fee() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_pho_pool_simple_swap_should_panic_when_user_accepted_fee_is_less_than_pool_fee() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_swap_should_fail_when_referral_fee_is_larger_than_allowed() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_swap_fee_variants(swap_fees: i64, commission_fee: i128) {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_v_phx_vul_021_should_panic_when_max_spread_invalid_range(max_spread: Option<i64>) {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_v_phx_vul_017_should_panic_when_swapping_non_existing_token_in_pool() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
#[should_panic(expected = "HostError: Error(Contract, #315)")]
fn test_pho_pool_v_phx_vul_017_should_panic_when_simulating_swap_for_non_existing_token_in_pool() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
#[should_panic(expected = "HostError: Error(Contract, #315)")]
fn test_pho_pool_v_phx_vul_017_should_panic_when_simulating_reverse_swap_for_non_existing_token_in_pool() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
#[test]
fn test_pho_pool_should_swap_with_valid_ask_asset_min_amount() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
...
fn test_pho_pool_should_fail_when_invalid_ask_asset_min_amount() {
    let env = Env::default();
    env.mock_all_auths();
    env.cost_estimate().budget().reset_unlimited();
