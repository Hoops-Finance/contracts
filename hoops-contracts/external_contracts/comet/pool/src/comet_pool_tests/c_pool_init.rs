...
fn test_comet_pool_init() {
    ...
    */
    ...
    assert_eq!(token_1.balance(&controller), 0);
    assert_eq!(token_2.balance(&controller), 0);
    assert_eq!(token_1.balance(&contract_id), STROOP);
    assert_eq!(token_2.balance(&contract_id), STROOP);
